...
package talend_projet.toto_0_1;
 ...
 * @status 
 */
public class toto implements TalendJob {
	...
	private final String jobName = "toto";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(toto.this, new Object[] { e,
	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String messagetMsgBox_1 = "Hello world! creation job";
	...
	public static void main(String[] args) {
		final toto totoClass = new toto();

		int exitCode = totoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = toto.class.getClassLoader()
					.getResourceAsStream(
							"talend_projet/toto_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : toto");
		}
...
/************************************************************************************************
 * 21522 characters generated by Talend Open Studio for Data Integration on the
 * 21 mars 2019 22:10:16 CET
 ************************************************************************************************/
