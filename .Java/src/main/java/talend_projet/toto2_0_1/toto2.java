...
package talend_projet.toto2_0_1;
...
/**
 * Job: toto2 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.2.1.20160704_1411
 * @status 
 */
public class toto2 implements TalendJob {
	...
	private final String jobName = "toto2";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(toto2.this, new Object[] { e,
	...
	public static void main(String[] args) {
		final toto2 toto2Class = new toto2();

		int exitCode = toto2Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = toto2.class.getClassLoader()
					.getResourceAsStream(
							"talend_projet/toto2_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : toto2");
		}
