...
package talend_projet.copy_of_toto_0_1;
...
/**
 * Job: Copy_of_toto Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.2.1.20160704_1411
 * @status 
 */
public class Copy_of_toto implements TalendJob {
	...
	private final String jobName = "Copy_of_toto";
	private final String projectName = "TALEND_PROJET";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_toto.this, new Object[] { e,
	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String messagetMsgBox_1 = "Hello world! creation job from ws bis";
	...
	public static void main(String[] args) {
		final Copy_of_toto Copy_of_totoClass = new Copy_of_toto();

		int exitCode = Copy_of_totoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_toto.class.getClassLoader()
					.getResourceAsStream(
							"talend_projet/copy_of_toto_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Copy_of_toto");
		}
...
/************************************************************************************************
 * 21638 characters generated by Talend Open Studio for Data Integration on the
 * 21 mars 2019 23:58:19 CET
 ************************************************************************************************/
